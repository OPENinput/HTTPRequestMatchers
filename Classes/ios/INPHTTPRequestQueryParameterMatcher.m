...
- (BOOL)evaluateRequest:(NSURLRequest *)request {
    NSString *parameter = [NSString stringWithFormat:@"%@=%@", [self.parameter stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding], [self.value stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
